...
// Ensure 'db' is only exported if the Firebase app is actually initialized.
// This prevents trying to get firestore from a non-existent app.
...
if (admin.apps.length > 0) {
  try {
    ...
    console.error("Error getting Firestore DB instance:", error);
  }
} else {
  console.error(
    "Firebase app not initialized, cannot get Firestore DB instance."
  );
}
